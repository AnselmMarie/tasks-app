...
const IconLayoutSidebarRightExpandFilled = (_props: any) => {
...
const Memo = memo(themed(IconLayoutSidebarRightExpandFilled))
export { Memo as IconLayoutSidebarRightExpandFilled }
