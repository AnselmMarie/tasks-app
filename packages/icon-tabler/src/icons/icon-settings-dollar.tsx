...
const IconSettingsDollar = (_props: any) => {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" {...props}>
      ...
      >
        ...
        <Path d="M15 12a3 3 0 1 0-1.724 2.716M21 15h-2.5a1.5 1.5 0 0 0 0 3h1a1.5 1.5 0 0 1 0 3H17m2 0v1m0-8v1" />
      </G>
    </Svg>
  )
}
const Memo = memo(themed(IconSettingsDollar))
export { Memo as IconSettingsDollar }
