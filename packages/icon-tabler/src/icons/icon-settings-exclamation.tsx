...
const IconSettingsExclamation = (_props: any) => {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" {...props}>
      ...
      >
        ...
        <Path d="M9 12a3 3 0 1 0 6 0 3 3 0 0 0-6 0m10 4v3m0 3v.01" />
      </G>
    </Svg>
  )
}
const Memo = memo(themed(IconSettingsExclamation))
export { Memo as IconSettingsExclamation }
