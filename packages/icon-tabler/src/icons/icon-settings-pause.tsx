...
const IconSettingsPause = (_props: any) => {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" {...props}>
      ...
      >
        ...
        <Path d="M9 12a3 3 0 1 0 6 0 3 3 0 0 0-6 0m8 5v5m4-5v5" />
      </G>
    </Svg>
  )
}
const Memo = memo(themed(IconSettingsPause))
export { Memo as IconSettingsPause }
