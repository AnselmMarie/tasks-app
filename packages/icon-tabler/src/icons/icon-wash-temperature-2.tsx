...
const IconWashTemperature_2 = (_props: any) => {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" {...props}>
      ...
      >
        ...
        <Path d="m3 6 1.721 10.329A2 2 0 0 0 6.694 18h10.612a2 2 0 0 0 1.973-1.671L21 6m-7 7h.01M10 13h.01" />
      </G>
    </Svg>
  )
}
const Memo = memo(themed(IconWashTemperature_2))
export { Memo as IconWashTemperature_2 }
