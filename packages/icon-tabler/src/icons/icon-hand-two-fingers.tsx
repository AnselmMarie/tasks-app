...
const IconHandTwoFingers = (_props: any) => {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" {...props}>
      ...
      >
        ...
        <Path d="M14 10.5a1.5 1.5 0 0 1 3 0V12m-6-6.5v-2a1.5 1.5 0 1 1 3 0V12" />
      </G>
    </Svg>
  )
}
const Memo = memo(themed(IconHandTwoFingers))
export { Memo as IconHandTwoFingers }
