...
const IconHandMiddleFinger = (_props: any) => {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" {...props}>
      <G
        ...
        strokeWidth={2}
      >
        <Path d="M8 13v-2.5a1.5 1.5 0 0 1 3 0V12m3-1.5a1.5 1.5 0 0 1 3 0V12" />
...
const Memo = memo(themed(IconHandMiddleFinger))
export { Memo as IconHandMiddleFinger }
