...
const IconSettingsSearch = (_props: any) => {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" {...props}>
      ...
      >
        ...
        <Path d="M14.985 11.694a3 3 0 1 0-3.29 3.29M15 18a3 3 0 1 0 6 0 3 3 0 1 0-6 0m5.2 2.2L22 22" />
      </G>
    </Svg>
  )
}
const Memo = memo(themed(IconSettingsSearch))
export { Memo as IconSettingsSearch }
