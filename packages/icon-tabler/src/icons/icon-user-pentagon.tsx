...
const IconUserPentagon = (_props: any) => {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" {...props}>
      ...
      >
        ...
        <Path d="M12 13a3 3 0 1 0 0-6 3 3 0 0 0 0 6m-6 7.703V20a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v.707" />
      </G>
    </Svg>
  )
}
const Memo = memo(themed(IconUserPentagon))
export { Memo as IconUserPentagon }
