...
const IconSettingsPin = (_props: any) => {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" {...props}>
      ...
      >
        ...
        <Path d="M14.99 12.256a3 3 0 1 0-2.33 2.671m8.461 5.194a3 3 0 1 0-4.242 0c.418.419 1.125 1.045 2.121 1.879 1.051-.89 1.759-1.516 2.121-1.879M19 18v.01" />
      </G>
    </Svg>
  )
}
const Memo = memo(themed(IconSettingsPin))
export { Memo as IconSettingsPin }
