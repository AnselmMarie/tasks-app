...
const IconLayoutSidebarLeftExpandFilled = (_props: any) => {
...
const Memo = memo(themed(IconLayoutSidebarLeftExpandFilled))
export { Memo as IconLayoutSidebarLeftExpandFilled }
