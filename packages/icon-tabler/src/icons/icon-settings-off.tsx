...
const IconSettingsOff = (_props: any) => {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" {...props}>
      ...
      >
        ...
        <Path d="M9.889 9.869a3 3 0 1 0 4.226 4.26m.592-3.424a3.012 3.012 0 0 0-1.419-1.415M3 3l18 18" />
      </G>
    </Svg>
  )
}
const Memo = memo(themed(IconSettingsOff))
export { Memo as IconSettingsOff }
